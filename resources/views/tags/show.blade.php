...
@section('title','MyBlog Tag ' . $tag->name)
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="block-21 d-flex animate-box post">
                    ...
                    <div class="text">
                        <h3 class="heading">
                            <a href="{{ route('post.show', $post) }}" class="date">{{ $post->title }}</a>
                        </h3>
                        ...
                        <div class="meta">
                            ...
                            <div class="comment-count">
                                <a href="{{ route('post.show', $post) }}#post-comments"><span class="icon-chat"></span> {{ $post->comments_count }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                @empty
                <p class="lead">There are no posts to this Tag</p>
                @endforelse
