    ...
    <body>
        ...
        <div id="page">
                                    ...
                                    <li class="has-dropdown">
                                        ...
                                        <ul class="dropdown">
                                            <li>
                                                <a
                                                   href="#"
                                                   onclick="event.preventDefault(); document.getElementById('nav-logout-form').submit();">Logout</a>
                                                <form
                                                      id="nav-logout-form"
                                                      action="{{ route('logout') }}"
                                                      method="POST">
            ...
            <div id="colorlib-subscribe" class="subs-img" style="background-image: url({{ asset('/blog_template/images/img_bg_2.jpg') }});" data-stellar-background-ratio="0.5">
                ...
                <div class="container">
                    <div class="row">
                        <div class="text-center col-md-8 col-md-offset-2 colorlib-heading animate-box">
