                ...
                <div class="border-0 card radius-10 border-start border-3 border-info">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-white widgets-icons-2 rounded-circle bg-gradient-scooter ms-auto"><i class='bx bxs-cart'></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-0 card radius-10 border-start border-3 border-danger">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-white widgets-icons-2 rounded-circle bg-gradient-bloody ms-auto"><i class='bx bxs-wallet'></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-0 card radius-10 border-start border-3 border-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="text-white widgets-icons-2 rounded-circle bg-gradient-blooker ms-auto"><i class='bx bxs-group'></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card radius-10">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="bg-transparent list-group-item d-flex justify-content-between align-items-center">Jeans <span class="badge bg-success rounded-pill">25</span>
                        </li>
                        ...
                        <div class="mb-0 border shadow-none card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="text-white widgets-icons-2 bg-gradient-moonlit ms-auto"><i class='bx bxs-share-alt'></i>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row row-cols-1 row-cols-lg-3">
            ...
            <div class="col d-flex">
                <div class="card radius-10 w-100">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="bg-transparent list-group-item d-flex justify-content-between align-items-center">Completed <span class="badge bg-gradient-quepal rounded-pill">25</span>
                        </li>
